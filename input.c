...
--*/
{
#if	PAL_HAS_PLATFORM_PROCESSEVENT_CAPSLOCK
	//
	// Turn on Caps Lock in advance for the user when he/she presses the key（Windows）
	//
	Platform_ProcessEvent_CapsLock();
#endif // PAL_HAS_PLATFORM_PROCESSEVENT_CAPSLOCK
