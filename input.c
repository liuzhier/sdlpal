...
static const int g_KeyMap[][2] = {
   ...
   { SDLK_d,         kKeyDefend },
   { SDLK_e,         kKeyUseItem },
   { SDLK_t,         kKeyThrowItem },
   { SDLK_q,         kKeyFlee },
   { SDLK_f,         kKeyForce },
   { SDLK_s,         kKeyStatus },
   { SDLK_1,         kKeyFastSave },
   { SDLK_1,         kKeyShowDataInBattle },
   { SDLK_2,         kKeyEnemyStatus },
   { SDLK_3,         kKeyPlayerLevelmagic,},
   { SDLK_w,         kKeyQuipmentItem },
   { SDLK_z,         kKeyMagicPageLeft },
   { SDLK_x,         kKeyMagicPageRight }
};
