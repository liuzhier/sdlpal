...
void main()
{
   ...
   else
   {
      ...
      if (BloomBlendMode < 0.5)
      {
         ...
         bloom.r += bloomOverdrive.g * 0.6;
         bloom.r += bloomOverdrive.b * 0.6;
         bloom.g += bloomOverdrive.r * 0.6;
         bloom.g += bloomOverdrive.b * 0.6;
         bloom.b += bloomOverdrive.r * 0.6;
         bloom.b += bloomOverdrive.g * 0.6;
