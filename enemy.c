...
)
{
	...
	INT w = gpGlobals->g.rgObject[wObjectID].enemy.wResistanceToSorcery * 10;
...
)
{
	...
	return g_Battle.rgEnemy[wEnemyIndex].e.wHealth;
}
...
)
{
	...
	INT w = g_Battle.rgEnemy[wEnemyIndex].e.wPoisonResistance;
...
)
{
	...
	INT w = g_Battle.rgEnemy[wEnemyIndex].e.wPhysicalResistance;
...
)
{
	...
	INT w = g_Battle.rgEnemy[wEnemyIndex].e.wElemResistance[iAttrib];
...
)
{
	...
	INT s = g_Battle.rgEnemy[wEnemyIndex].e.wLevel;
	s += 1;
